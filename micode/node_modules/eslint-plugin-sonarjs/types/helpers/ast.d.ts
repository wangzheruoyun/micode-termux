...
export declare function isTypeOnlyImport(node: estree.ImportDeclaration): boolean;
 ...
 */
export declare function isStaticMethodCall(node: estree.Node, objectName: string, methodName: string): node is estree.CallExpression;
