 ...
 */
export declare function clearFileCaches(): void;
export declare function getCurrentFileImports(sourceCode: SourceCode): ReadonlySet<string>;
/**
 * Checks if the file imports any of the specified modules, either via require() calls or import declarations.
 */
export declare function importsModule(context: Rule.RuleContext, moduleNames: string[]): boolean;
/**
 ...
 */
export declare function importsOrDependsOnModule(context: Rule.RuleContext, imports: string[], dependencies: string[]): boolean;
