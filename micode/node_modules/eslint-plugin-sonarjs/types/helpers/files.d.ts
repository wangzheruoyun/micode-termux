...
export declare function assertNestedPath(from: NormalizedAbsolutePath, topDir: NormalizedAbsolutePath): void;
/**
 ...
 */
export declare function getPathRoot(filePath: NormalizedAbsolutePath): NormalizedAbsolutePath;
...
export declare function relativeToAncestorPath(filePath: NormalizedAbsolutePath, topDir: NormalizedAbsolutePath): string | undefined;
/**
