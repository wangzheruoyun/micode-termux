export declare const rules: {
    ...
    'no-fixed-wait-in-tests': import("eslint").Rule.RuleModule;
    ...
    'parameterized-tests': import("eslint").Rule.RuleModule;
    ...
    'assertions-in-test-cases': import("eslint").Rule.RuleModule;
    'synchronous-suite-callback': import("eslint").Rule.RuleModule;
    'super-linear-regex': import("eslint").Rule.RuleModule;
    'prefer-native-lodash-alternative': import("eslint").Rule.RuleModule;
    'no-default-utility-imports': import("eslint").Rule.RuleModule;
    'memoize-cache-key': import("eslint").Rule.RuleModule;
    'no-debug-commands-in-ui-tests': import("eslint").Rule.RuleModule;
    'no-mixed-completion-style': import("eslint").Rule.RuleModule;
    'no-interpolation-in-inline-snapshots': import("eslint").Rule.RuleModule;
    'explicit-test-skip': import("eslint").Rule.RuleModule;
};
