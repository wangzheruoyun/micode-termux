...
function isDefensiveIndexedNullishCheck(left, right) {
    return ((isNullishLiteral(left) && isIndexedAccess(right)) ||
        (isNullishLiteral(right) && isIndexedAccess(left)));
}
function isNullishLiteral(node) {
    return ((0, ast_js_1.isNullLiteral)(node) ||
        (0, ast_js_1.isUndefined)(node) ||
