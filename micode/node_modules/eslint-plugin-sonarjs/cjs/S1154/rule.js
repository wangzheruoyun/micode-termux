...
exports.rule = {
    ...
    create(context) {
        ...
        function isFunctionType(arg) {
            if (!arg || arg.type === 'SpreadElement') {
                return false;
            }
            return (0, type_js_1.getTypeFromTreeNode)(arg, services).getCallSignatures().length > 0;
        }
        function isCallbackBasedReplacement(property, args) {
