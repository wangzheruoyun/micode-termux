...
exports.shapeDependentMethods = exports.replacements = exports.methodNamesByLowerCase = exports.methodNames = exports.callbackCollectionMethods = void 0;
const ES5 = 5;
const ES2015 = 2015;
const ES2016 = 2016;
const ES2017 = 2017;
...
const COLLECTION_PREDICATE_REASON = 'the library also accepts objects, nullish values, and shorthand predicates';
...
const replacements = {
    ...
    contains: cautious('Array.prototype.includes()', 'the library also accepts strings, objects, and nullish values', ES2016),
    drop: cautious(ARRAY_SLICE_ALTERNATIVE, ARRAY_NULLISH_REASON, ES5, '`array.slice(n)`'),
    dropRight: cautious(ARRAY_SLICE_ALTERNATIVE, ARRAY_NULLISH_REASON, ES5, '`n === 0 ? array.slice() : array.slice(0, -n)`'),
    ...
    flatten: cautious('Array.prototype.flat()', 'the library handles nullish values differently from the native API', ES2019),
    includes: cautious('Array.prototype.includes()', 'the library also accepts strings, objects, and nullish values', ES2016),
    ...
    takeRight: cautious(ARRAY_SLICE_ALTERNATIVE, ARRAY_NULLISH_REASON, ES5, '`n === 0 ? [] : array.slice(-n)`'),
...
const methodNamesByLowerCase = new Map(Object.keys(replacements).map(method => [method.toLowerCase(), method]));
exports.methodNamesByLowerCase = methodNamesByLowerCase;
...
exports.shapeDependentMethods = shapeDependentMethods;
const callbackCollectionMethods = new Set([...shapeDependentMethods].filter(method => method !== 'contains' && method !== 'includes'));
exports.callbackCollectionMethods = callbackCollectionMethods;
function direct(alternative, minimumEcmaVersion) {
    return { alternative, minimumEcmaVersion };
}
function cautious(alternative, reason, minimumEcmaVersion, example) {
