...
const fp = __importStar(require("./false-positives/index.js"));
const helpers_js_1 = require("./false-positives/helpers.js");
...
exports.rule = {
    ...
    create(context) {
        ...
        const ruleContext = { context, sourceCode, services };
        return {
            'CallExpression[arguments.length=0][callee.type="MemberExpression"]': (call) => {
                ...
                if (helpers_js_1.allSortLike.has(text) && (0, type_js_1.isArrayLikeType)(type, services)) {
