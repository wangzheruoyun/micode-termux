...
function checkMulter(context, callExpression) {
    ...
    if (callExpression.callee.type === 'Identifier') {
        const fqn = (0, module_js_1.getFullyQualifiedName)(context, callExpression.callee);
...
function evaluateBinaryExpression(context, node, visited) {
...
function getSizeValue(context, node, visited = new Set()) {
    if (visited.has(node)) {
        return null;
    }
    visited.add(node);
