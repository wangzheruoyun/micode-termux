...
exports.isThenableOrGuardUnion = isThenableOrGuardUnion;
exports.isAny = isAny;
...
const NOTHING_TYPE_FLAGS = typescript_1.default.TypeFlags.Void | typescript_1.default.TypeFlags.Undefined | typescript_1.default.TypeFlags.Null;
/**
 ...
 */
function isThenableOrGuardUnion(node, services) {
    return isThenableUnionWithGuards(node, services, NOTHING_TYPE_FLAGS | typescript_1.default.TypeFlags.BooleanLike);
}
function isThenableUnionWithGuards(node, services, guardFlags) {
    const checker = services.program.getTypeChecker();
    const type = getTypeFromTreeNode(node, services);
