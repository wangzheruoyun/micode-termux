...
exports.assertNestedPath = assertNestedPath;
exports.getPathRoot = getPathRoot;
exports.isAbsolutePath = isAbsolutePath;
exports.dirnamePath = dirnamePath;
exports.relativeToAncestorPath = relativeToAncestorPath;
...
function assertNestedPath(from, topDir) {
 ...
 */
function getPathRoot(filePath) {
    const winRoot = (0, win32_1.parse)(filePath).root;
    if (winRoot) {
        return toUnixPath(winRoot);
    }
...
function relativeToAncestorPath(filePath, topDir) {
