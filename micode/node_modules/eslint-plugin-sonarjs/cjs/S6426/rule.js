...
const Playwright = __importStar(require("../helpers/playwright.js"));
        ...
        return {
            CallExpression: (node) => {
                if ((0, ast_js_1.isMethodCall)(node)) {
                    ...
                    if ((0, ast_js_1.isIdentifier)(property, 'only') && isExclusiveTestFunction(object)) {
                        context.report({
                            messageId: 'issue',
                            node: property,
                            suggest: [
...
function isExclusiveTestFunction(node) {
    return (0, ast_js_1.isIdentifier)(node, ...exclusiveTestFunctionNames) || Playwright.isDescribe(node);
}
